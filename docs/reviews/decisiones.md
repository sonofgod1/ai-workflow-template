...
**9 hallazgo(s):** 0 sin cerrar, 9 resuelto(s), 0 descartado(s).
...
| I5 | un arreglo a un hook nunca llega: el sync escribe git-hooks/, pero corre .git/hooks/ | `1c3c1a6` | ✅ probado — `.workflow/tests/test-sync-commit.py` | 2026-09-11 |
