...
**Pregunta primero si trabaja solo o en equipo.** No es un detalle: exigir 1 aprobación
en un repo de una sola persona lo deja sin forma de mergear, porque GitHub no permite
...
```bash
# `gh api -f` manda todo como string y este endpoint exige booleanos, enteros y
...
**Si trabaja en equipo** — además, review de code owners:
