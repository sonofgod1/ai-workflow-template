...
|----------|-------|----------------|
| `docs` | discovery, architect, contracts, feature, plan, review, security, ux, deploy | solo `docs/` |
...
6. Tú pruebas manualmente todos los casos del plan
...
10. git commit -m "fix(ID): descripción"         ← código
